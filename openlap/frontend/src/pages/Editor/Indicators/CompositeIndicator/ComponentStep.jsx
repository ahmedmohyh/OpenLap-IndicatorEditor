...
import {
  generateCompositeIndicatorPreview,
  saveCompositeIndicatorPreview,
  setGeneratedCompositeVisualizationCode,
} from "../../../../utils/redux/reducers/compositeEditor";
...
export default function ComponentStep(props) {
  ...
  const selectIndicators = useSelector(
    (state) => state.compositeEditorReducer.selectedData.indicators
  );
  ...
  const basicIndicatorPreviewMap = useSelector(
    (state) => state.compositeEditorReducer.baiscIndicatorPreviewList
  );
  ...
  const handleOpenVisualization = () => {
    ...
    dispatch(
      generateCompositeIndicatorPreview(getCompositeIndicatorPreviewCode)
    );
